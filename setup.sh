...
echo "     # Or use: python scripts/preprocess.py (if created)"
echo ""
echo "  4. Train the model:"
echo "     python train.py"
echo "     # Or use: python scripts/train.py (if created)"
echo ""
echo "  5. Evaluate the model:"
echo "     python evaluate.py"
echo "     # Or use: python scripts/evaluate.py (if created)"
echo ""
echo "💡 Tip: For Jupyter notebook workflow, run:"
echo "     jupyter lab notebooks/vastai_workflow.ipynb"
echo ""
